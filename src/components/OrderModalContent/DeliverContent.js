...
export default class DeliverContent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isShowDetail: false,
  ...
  render() {
    ...
    return (
      <div className="invoice-content">
        <div>
          <p>收货单位：{guestInfo.company_name}</p>
          <p>收货方式：配送</p>
        </div>

        <div className="">
          <p>收货人：{guestInfo.receiver}</p>
          <p>联系电话：{guestInfo.mobile}</p>
          <p>地址：{guestInfo.address}</p>
        </div>
